...
public class MultiLanguageUtils {
    ...
    public static void changeLanguage(Context context, String language, String area) {
        if (TextUtils.isEmpty(language) && TextUtils.isEmpty(area)) {
            //如果语言和地区都是空，那么跟随系统s
            SPUtils.getInstance().put(BaseConstant.LOCALE_LANGUAGE, "");
            SPUtils.getInstance().put(BaseConstant.LOCALE_COUNTRY, "");
...
//    }
    ...
    public static boolean isSameWithSetting(Context context) {
        ...
        String sp_language = SPUtils.getInstance().getString(BaseConstant.LOCALE_LANGUAGE);
        String sp_country = SPUtils.getInstance().getString(BaseConstant.LOCALE_COUNTRY);
...
//    }
    ...
    public static void saveLanguageSetting(Locale locale) {
        ...
        SPUtils.getInstance().put(BaseConstant.LOCALE_LANGUAGE, locale.getLanguage());
        SPUtils.getInstance().put(BaseConstant.LOCALE_COUNTRY, locale.getCountry());
    }
...
//    }
    ...
    public static Application.ActivityLifecycleCallbacks callbacks = new Application.ActivityLifecycleCallbacks() {
        ...
        public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
            String language = SPUtils.getInstance().getString(BaseConstant.LOCALE_LANGUAGE);
            String country = SPUtils.getInstance().getString(BaseConstant.LOCALE_COUNTRY);
