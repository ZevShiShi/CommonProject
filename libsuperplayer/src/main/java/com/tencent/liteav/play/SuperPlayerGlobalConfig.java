...
public class SuperPlayerGlobalConfig {
     ...
     */
    public int renderLiveMode = TXLiveConstants.RENDER_MODE_FULL_FILL_SCREEN;

    public int renderVideoMode = TXLiveConstants.RENDER_MODE_ADJUST_RESOLUTION;    // RENDER_MODE_ADJUST_RESOLUTION
